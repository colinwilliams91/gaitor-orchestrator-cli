...
test('scaffolds README image and all harness files by default with --yes', () => {
  ...
  try {
    ...
    assert.match(readme, /<img src="https:\/\/res\.cloudinary\.com\/dbdyc4klu\/image\/upload\/c_scale,w_400\/v1775255978\/gaitor-orchestrator-00_r6llds_c_pad_w_500_h_500_ar_1_1_1_jpd0up\.webp"/);
